...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/gatewayproducerredis/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "GatewayProducerRedis"
	gvk := v1alpha1.GroupVersion.WithKind("GatewayProducerRedis")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.GatewayProducerRedis{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRedis)
	if !ok {
		return nil, errors.New("expected *v1alpha1.GatewayProducerRedis")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRedis)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.GatewayProducerRedis")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRedis)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.GatewayProducerRedis")
	}

	body := akeyless.GatewayCreateProducerRedis{
		Name:  meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.GatewayCreateProducerRedis(ctx).GatewayCreateProducerRedis(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRedis)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.GatewayProducerRedis")
	}

	body := akeyless.GatewayUpdateProducerRedis{
		Name:  meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map mutable cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.GatewayUpdateProducerRedis(ctx).GatewayUpdateProducerRedis(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRedis)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.GatewayProducerRedis")
	}
