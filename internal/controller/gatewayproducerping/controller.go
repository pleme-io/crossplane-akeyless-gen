...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/gatewayproducerping/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "GatewayProducerPing"
	gvk := v1alpha1.GroupVersion.WithKind("GatewayProducerPing")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.GatewayProducerPing{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerPing)
	if !ok {
		return nil, errors.New("expected *v1alpha1.GatewayProducerPing")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerPing)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.GatewayProducerPing")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerPing)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.GatewayProducerPing")
	}

	body := akeyless.GatewayCreateProducerPing{
		Name:  meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.GatewayCreateProducerPing(ctx).GatewayCreateProducerPing(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerPing)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.GatewayProducerPing")
	}

	body := akeyless.GatewayUpdateProducerPing{
		Name:  meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map mutable cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.GatewayUpdateProducerPing(ctx).GatewayUpdateProducerPing(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerPing)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.GatewayProducerPing")
	}
