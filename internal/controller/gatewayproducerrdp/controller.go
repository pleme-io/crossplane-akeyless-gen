...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/gatewayproducerrdp/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "GatewayProducerRdp"
	gvk := v1alpha1.GroupVersion.WithKind("GatewayProducerRdp")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.GatewayProducerRdp{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRdp)
	if !ok {
		return nil, errors.New("expected *v1alpha1.GatewayProducerRdp")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRdp)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.GatewayProducerRdp")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRdp)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.GatewayProducerRdp")
	}
	...
	_, _, err := e.client.V2API.GatewayCreateProducerRdp(ctx).GatewayCreateProducerRdp(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRdp)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.GatewayProducerRdp")
	}
	...
	_, _, err := e.client.V2API.GatewayUpdateProducerRdp(ctx).GatewayUpdateProducerRdp(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerRdp)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.GatewayProducerRdp")
	}
