...
package gatewaylogforwardingsumologic
...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/gatewaylogforwardingsumologic/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "GatewayLogForwardingSumologic"
	gvk := v1alpha1.GroupVersion.WithKind("GatewayLogForwardingSumologic")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.GatewayLogForwardingSumologic{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.GatewayLogForwardingSumologic)
	if !ok {
		return nil, errors.New("expected *v1alpha1.GatewayLogForwardingSumologic")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.GatewayLogForwardingSumologic)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.GatewayLogForwardingSumologic")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	_, ok := mg.(*v1alpha1.GatewayLogForwardingSumologic)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.GatewayLogForwardingSumologic")
	}

	body := akeyless.GatewayUpdateLogForwardingSumologic{
		Token: &e.token,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.GatewayUpdateLogForwardingSumologic(ctx).GatewayUpdateLogForwardingSumologic(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	_, ok := mg.(*v1alpha1.GatewayLogForwardingSumologic)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.GatewayLogForwardingSumologic")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	_, ok := mg.(*v1alpha1.GatewayLogForwardingSumologic)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.GatewayLogForwardingSumologic")
	}

	body := akeyless.GatewayUpdateLogForwardingSumologic{
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.GatewayUpdateLogForwardingSumologic(ctx).GatewayUpdateLogForwardingSumologic(body).Execute()
