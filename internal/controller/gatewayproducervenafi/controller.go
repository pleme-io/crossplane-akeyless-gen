...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/gatewayproducervenafi/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "GatewayProducerVenafi"
	gvk := v1alpha1.GroupVersion.WithKind("GatewayProducerVenafi")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.GatewayProducerVenafi{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerVenafi)
	if !ok {
		return nil, errors.New("expected *v1alpha1.GatewayProducerVenafi")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerVenafi)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.GatewayProducerVenafi")
	}
	...
	_, resp, err := e.client.V2API.GatewayGetProducer(ctx).GatewayGetProducer(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerVenafi)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.GatewayProducerVenafi")
	}

	body := akeyless.GatewayCreateProducerVenafi{
		Name:  meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.GatewayCreateProducerVenafi(ctx).GatewayCreateProducerVenafi(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerVenafi)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.GatewayProducerVenafi")
	}

	body := akeyless.GatewayUpdateProducerVenafi{
		Name:  meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map mutable cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.GatewayUpdateProducerVenafi(ctx).GatewayUpdateProducerVenafi(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerVenafi)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.GatewayProducerVenafi")
	}

	body := akeyless.GatewayDeleteProducer{
		Name:  meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.GatewayDeleteProducer(ctx).GatewayDeleteProducer(body).Execute()
