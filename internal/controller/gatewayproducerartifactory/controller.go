...
package gatewayproducerartifactory
...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/gatewayproducerartifactory/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "GatewayProducerArtifactory"
	gvk := v1alpha1.GroupVersion.WithKind("GatewayProducerArtifactory")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.GatewayProducerArtifactory{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerArtifactory)
	if !ok {
		return nil, errors.New("expected *v1alpha1.GatewayProducerArtifactory")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerArtifactory)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.GatewayProducerArtifactory")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerArtifactory)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.GatewayProducerArtifactory")
	}
	...
	_, _, err := e.client.V2API.GatewayCreateProducerArtifactory(ctx).GatewayCreateProducerArtifactory(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerArtifactory)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.GatewayProducerArtifactory")
	}
	...
	_, _, err := e.client.V2API.GatewayUpdateProducerArtifactory(ctx).GatewayUpdateProducerArtifactory(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.GatewayProducerArtifactory)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.GatewayProducerArtifactory")
	}
