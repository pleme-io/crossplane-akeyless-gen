...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/kmipenvironmentv2/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "KmipEnvironmentV2"
	gvk := v1alpha1.GroupVersion.WithKind("KmipEnvironmentV2")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.KmipEnvironmentV2{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.KmipEnvironmentV2)
	if !ok {
		return nil, errors.New("expected *v1alpha1.KmipEnvironmentV2")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.KmipEnvironmentV2)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.KmipEnvironmentV2")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.KmipEnvironmentV2)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.KmipEnvironmentV2")
	}
...
func (e *external) Update(_ context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	_, ok := mg.(*v1alpha1.KmipEnvironmentV2)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.KmipEnvironmentV2")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	_, ok := mg.(*v1alpha1.KmipEnvironmentV2)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.KmipEnvironmentV2")
	}
